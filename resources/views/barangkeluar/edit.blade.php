                    ...
                    <div class="card-body">
                        <form action="{{ route('barangkeluar.update',$rsetBarang->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tgl_keluar') is-invalid @enderror" name="tgl_keluar" value="{{ old('tgl_keluar',$rsetBarang->tgl_keluar) }}">
                                @error('tgl_keluar')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('qty_keluar') is-invalid @enderror" name="qty_keluar" value="{{ old('qty_keluar',$rsetBarang->qty_keluar) }}">
                                @error('qty_keluar')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
